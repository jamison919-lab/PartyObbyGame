...
local close=Instance.new("TextButton");close.Position=UDim2.fromScale(.88,.02);close.Size=UDim2.fromScale(.09,.07);close.Text="X";close.Selectable=true;close.Parent=frame;close.Activated:Connect(function()gui.Enabled=false end)
