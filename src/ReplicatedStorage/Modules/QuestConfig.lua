...
return table.freeze({
	...
	TowerFloor6={Id="TowerFloor6",DisplayName="高塔探險",Description="抵達塔樓第 6 層",Target=6,RewardCoins=120,AllowedModes={"SoloTower","SoloTower02"},ProgressEvent="TowerFloor",IsEnabled=true},
