...
return table.freeze({
	...
	SoloTower02={Id="SoloTower02",DisplayName="單人機關高塔",Description="挑戰村長的十二層機關塔",MinimumPlayers=1,RecommendedPlayers=1,MaximumPlayers=1,IsRanked=false,IsSolo=true,QueueDuration=0,MatchDuration=420,MapPool={"Tower02"},RewardsEnabled=true,RankPointsEnabled=false,ItemsEnabled=false,AllowLateJoin=false,ReturnToLobbyAfterFinish=true},
})
